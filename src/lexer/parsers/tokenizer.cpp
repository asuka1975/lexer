...
lexer::parser::Tokenizer::Tokenizer(std::unique_ptr<RuleSet> rule_set)
    : rules(std::move(rule_set)) {}

lexer::parser::Tokenizer::TokenizeState lexer::parser::Tokenizer::read(char c) {
    ...
    return candidacies.empty() ? TokenizeState::Reject : TokenizeState::Alexerept;
}

std::unique_ptr<lexer::parser::tokens::Token> lexer::parser::Tokenizer::pop() {
